...
<!--Cramos el script para la gráfica-->
...
//Llenamos los datos que queremos que contenga
...
<form action="">
    ...
    <div class="form-row mt-3">
        ...
        <h3 class="text-dark container mt-4">Calificaciones</h3>
       </div>
  ...
  <div class=" pb-1 table-responsive">
      ...
      <tbody>
        <tr>
          ...
          <td></td>
          <td>Que pasó ahí</td>
          <td><a href="calificar"><button class="btn btn-success">Calificar</button></a></td>
        </tr>
      </tbody>
    </table>
  </div>
