...
<!--EMPIEZA FORMULARIO PARA ACTUALIZAR LOS DATOS DE UN ALUMNO-->
<div class="border container rounded" style="background-color: rgba(   247, 249, 249  );">

<h3 class="text-dark container pl-5 mt-5">Actualizar datos de un alumno</h3>
<br>
<form class="container pl-5 pr-5 text-success">
  ...
  <div class="form-row mt-3">
    ...
    <!--TELEFONO DE CASA, CELULAR Y CORREO-->
      ...
      <!--DIRECCION, CODIGO POSTAL Y CORREO-->
      <div class="form-row mt-3">
...
<div class="form-group col-sm-4">
  ...
  <a name="actualizar alumno" id="a"></a>
