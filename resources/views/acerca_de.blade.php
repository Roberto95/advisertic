...
<style type="text/css" >
  ...
  <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
    <div  class="ml-5"><span class="navbar-toggler-icon"></span></div>
  </button>
  <!--clase para colapsar le menú de navegación-->
  <div class="collapse navbar-collapse ml-5 pl-5" id="navbarNavAltMarkup">
    <div class="navbar-nav mr-auto ml-auto mr-5 pr-5 text-center text-light">
        ...
        <a class="nav-item nav-link active" href="acerca_de"><img src="{{asset ('iconos/acercade.png')}}" width="20px" height="20px" alt="Acerca de nosostros" title="Acerca de nosotros"><br>Acerca de</a>
...
<br>
  ...
  <a name="acerca de nosotros" id="a"></a>
  <br>
   <h3 class="text-light container ml-5">Quienes somos?</h3>
  <div class="card-deck d-flex justify-content-center ml-5 mr-5">
      <div class="card text-white bg-danger">
        <img class="card-img-top" src="imagenes/ute.jpg" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Acerca de la UTE</h5>
          <p class="card-text text-justify">La Universidad Tecnológica Gral. Mariano Escobedo, es un Organismo Público Descentralizado del Estado de Nuevo León,
                               que contribuye a consolidar los programas de desarrollo de la educación superior tecnológica en la entidad, y que
                               forma parte del sistema nacional de Universidades Tecnológicas.</p>
        </div>

      </div>
      <div class="card text-dark bg-light">
        <img class="card-img-top" src="imagenes/maestros2.jpg" alt="Card image cap" height="37%">
        <div class="card-body">
          <h5 class="card-title">Acerca de Ticsi</h5>
          <p class="card-text text-justify">Promover el uso de la tecnología de la información dentro de su área de influencia laboral con los que colabore contribuyendo a
                               elevar la eficiencia y la competitividad de las organizaciones a través de la aplicación de sistemas de información, soportadas
                               por tecnología de vanguardia.</p>
        </div>
      </div>

      <div class="card text-white bg-dark">
        <img class="card-img-top" src="imagenes/maestros.jpg" alt="Card image cap" height="37%">
        <div class="card-body">
          <h5 class="card-title">Acerca de este sitio</h5>
          <p class="card-text text-justify">En este sitio se podrán
                                            agregar las calificaciones de los alumnos, además de poder manipular otros datos sobre los mismos,
                                            todo esto para tener un mejor control sobre dicha información y conocer a los alumnos que tienen un buen
                                            desempeño académico pero sobre todo a aquellos que tienen algun tipo de vulnerabilidad académica.
          </p>
        </div>
